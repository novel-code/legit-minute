...
function Home() {
  ...
  useEffect(function () {
    // UCctXZhXmG-kf3tlIXgVZUlw
    // const myChannelId = "UCGwXkssQEeaJ6ui95bmtNOg";
    // https://youtube.googleapis.com/youtube/v3/playlistItems?part=snippet&playlistId=PL6kVe2yYBgOWBT4YzuaeFVetAqVurIrze&key=[YOUR_API_KEY] HTTP/1.1
    // Authorization: Bearer [YOUR_ACCESS_TOKEN]
    // Accept: application/json
    // fetch(
    //   "https://youtube.googleapis.com/youtube/v3/playlistItems?part=snippet&playlistId=PL6kVe2yYBgOWBT4YzuaeFVetAqVurIrze&key=AIzaSyAqvsIErWUE79WBKarIlAV8l4zHU8KToEQ"
    // )
    //   .then((resp) => resp.json())
    //   .then((dat) => {
    //   });
    ...
    // const client_id =
    //   "291820083427-agaah4t9359vppoiidgg06dc4l9gecj8.apps.googleusercontent.com";
    // const scope = "https://www.googleapis.com/auth/youtube";
    // const url = `https://accounts.google.com/o/oauth2/v2/auth?redirect_uri=${redirect_uri}&prompt=consent&response_type=code&client_id=${client_id}&scope=${scope}&access_type=offline`;
    // window.location = url;
    // const resp = await axios.get(
    //   "https://youtube.googleapis.com/youtube/v3/subscriptions?part=snippet%2CcontentDetails&mine=true&key=AIzaSyAqvsIErWUE79WBKarIlAV8l4zHU8KToEQ",
  ...
  async function loginYt2() {
    ...
    const client_secret = "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";
  ...
  async function getSubs() {
    //     GET https://youtube.googleapis.com/youtube/v3/subscriptions?part=snippet%2CcontentDetails&mine=true&key=[YOUR_API_KEY] HTTP/1.1
  ...
  return (
    <div className='min-h-full pb-20 bg-stone-950'>
      <h1 onClick={loginYt} className='p-3 text-lg text-center '>
        Legit Minute
      </h1>
      <div onClick={loginYt2}>get bearer tocka</div>
      <div onClick={getSubs}>get suscriptins</div>
      <List
        handlers={handlers}
